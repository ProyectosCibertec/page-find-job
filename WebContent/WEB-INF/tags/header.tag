			...
			<div
				...
				<ul
					...
					<f:if test="${u.isEmpresa == 1 || u == null}">
						<li><a href="publicar-ofertas.jsp"
							class="nav-link px-2 text-white">Publicar ofertas</a></li>
					</f:if>
				...
				<f:if test="${u != null}">
					<div class="dropdown text-end">
						...
						<ul class="dropdown-menu text-small"
							...
							<li><span class="dropdown-item disabled">${u.name }
									${u.lastName}</span></li>
							...
							<li><a class="dropdown-item" href="userServlet">Signs
									out</a></li>
						</ul>
					</div>
				</f:if>
